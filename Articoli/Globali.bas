...
Public Const BTN_ASSISTANT = 131072
Public Const BTN_HELP = 262144
Public Const BTN_SEARCHFORM = 524288
Public Const BTN_SEARCHTABLE = 1048576
Public Const BTN_FILTER = 1048576 * 2
Public Const BTN_TOOLS = BTN_FILTER * 2
Public Const BTN_ALL = BTN_TOOLS * 2 - 1
...
Public Cn As DmtADOLib.adoConnection
Public Db As DMTDBLib.Database
