...
Public Const IDDocumento As Long = 4
...
Public LINK_IVA_FORNITORE As Long
...
Public ABILITA_TAB_CONF As Long
...
Public ATTIVA_OBBLIGO_SFALCIO As Long
Public ATTIVA_SEQUENZA_SFALCIO As Long

Public LINK_LOTTO_PRODUZIONE_SEL As Long
