      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame fraRighe 
               ...
               Begin TabDlg.SSTab SSTab1 
                  ...
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  TabCaption(0)   =   "Stringa di codice EAN128"
                  ...
                  Tab(0).Control(4)=   "Label6(1)"
                  Tab(0).Control(4).Enabled=   0   'False
                  Tab(0).Control(5)=   "Label6(2)"
                  Tab(0).Control(5).Enabled=   0   'False
                  Tab(0).Control(6)=   "Label7"
                  Tab(0).Control(6).Enabled=   0   'False
                  Tab(0).Control(7)=   "Label5(1)"
                  Tab(0).Control(7).Enabled=   0   'False
                  Tab(0).Control(8)=   "LabelLink1"
                  Tab(0).Control(8).Enabled=   0   'False
                  Tab(0).Control(9)=   "txtNumeroDecimali"
                  Tab(0).Control(9).Enabled=   0   'False
                  Tab(0).Control(10)=   "txtPosizioneIdentificatore"
                  Tab(0).Control(10).Enabled=   0   'False
                  Tab(0).Control(11)=   "cmdNuovo"
                  Tab(0).Control(11).Enabled=   0   'False
                  Tab(0).Control(12)=   "cmdSalva"
                  Tab(0).Control(12).Enabled=   0   'False
                  Tab(0).Control(13)=   "cmdElimina"
                  Tab(0).Control(13).Enabled=   0   'False
                  Tab(0).Control(14)=   "GrigliaCorpo"
                  Tab(0).Control(14).Enabled=   0   'False
                  Tab(0).Control(15)=   "cboIndetificatore"
                  Tab(0).Control(15).Enabled=   0   'False
                  Tab(0).Control(16)=   "txtCodiceIndentificatore"
                  Tab(0).Control(16).Enabled=   0   'False
                  Tab(0).Control(17)=   "txtCampoEtichetta"
                  Tab(0).Control(17).Enabled=   0   'False
                  Tab(0).Control(18)=   "cmdCampiEtichetta"
                  Tab(0).Control(18).Enabled=   0   'False
                  Tab(0).Control(19)=   "txtValoreManuale"
                  Tab(0).Control(19).Enabled=   0   'False
                  Tab(0).Control(20)=   "txtPosizione"
                  Tab(0).Control(20).Enabled=   0   'False
                  Tab(0).Control(21)=   "cboTipoCampoEtichetta"
                  Tab(0).Control(21).Enabled=   0   'False
                  Tab(0).Control(22)=   "cmdNuovoiID"
                  Tab(0).Control(22).Enabled=   0   'False
                  Tab(0).ControlCount=   23
                  Begin VB.CommandButton cmdNuovoiID 
                     Height          =   280
                     Left            =   8880
                     Picture         =   "frmMain.frx":47A06
                     Style           =   1  'Graphical
                     TabIndex        =   36
                     Top             =   720
                     Width           =   375
                  End
                  Begin DMTDataCmb.DMTCombo cboTipoCampoEtichetta 
                     Height          =   315
                     Left            =   4320
                     TabIndex        =   7
                     Top             =   1320
                  ...
                  Begin DMTEDITNUMLib.dmtNumber txtPosizione 
                     ...
                     AllowEmpty      =   0   'False
                  End
                  Begin VB.TextBox txtValoreManuale 
                     Height          =   315
                     Left            =   6840
                     TabIndex        =   9
                     Top             =   1320
                     Width           =   3855
                  End
                  Begin VB.CommandButton cmdCampiEtichetta 
                     Caption         =   "..."
                     Height          =   285
                     Left            =   3720
                     TabIndex        =   6
                     ...
                     Width           =   495
                  End
                  Begin VB.TextBox txtCampoEtichetta 
                     Height          =   315
                     Left            =   120
                     Locked          =   -1  'True
                     TabIndex        =   5
                     ...
                     Width           =   3615
                  End
                  Begin VB.TextBox txtCodiceIndentificatore 
                     Alignment       =   2  'Center
                     Enabled         =   0   'False
                     Height          =   315
                     Left            =   9360
                     ...
                     Width           =   1335
                  End
                  Begin DMTDataCmb.DMTCombo cboIndetificatore 
                     Height          =   315
                     Left            =   120
                     TabIndex        =   2
                     Top             =   720
                  ...
                  Begin VB.CommandButton cmdNuovo 
                     ...
                     Width           =   1335
                  End
                  Begin DMTEDITNUMLib.dmtNumber txtPosizioneIdentificatore 
                     Height          =   315
                     Left            =   10800
                     TabIndex        =   4
                     TabStop         =   0   'False
                     ...
                     AllowEmpty      =   0   'False
                  End
                  Begin DMTEDITNUMLib.dmtNumber txtNumeroDecimali 
                     Height          =   315
                     Left            =   6000
                     TabIndex        =   8
                     TabStop         =   0   'False
                  ...
                  Begin VB.Label Label3 
                     Caption         =   "Codice identificatore EAN128"
                     Height          =   255
                     Left            =   120
                     TabIndex        =   28
                     Top             =   480
            ...
            Begin VB.Frame Frame3 
               Caption         =   "CONFIGURAZIONE CODICE EAN128"
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
               ...
               Top             =   120
               Width           =   11775
               Begin VB.TextBox txtStringaCodiceEAN128 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   1
                  Top             =   1200
               ...
               Begin VB.Label Label1 
                  Caption         =   "Stringa costruita per il codice EAN128"
                  Height          =   255
                  Left            =   120
                  TabIndex        =   27
                  Top             =   960
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtDescrizione
    Field.Name = "Descrizione"
    Field.Visible = True
    Me.txtDescrizione.Tag = Field.Name
...
'**************************COSTRUZIONE CODICE A BARRE EAN128*******************************

    'Crea un sottodocumento basato sulla tabella di cross "RV_POCostruzioneCodiceEAN128Righe"
    
    Set m_DocumentsLink1 = m_Document.AddDocumentsLink("RV_POCostruzioneCodiceEAN128Righe")
          
    'Impostazioni dell'oggetto DocumentsLink
    m_DocumentsLink1.EnableRefreshLinks = True '<-- Abilita il refresh dei campi collegati
    m_DocumentsLink1.PrimaryKey = "IDRV_POCostruzioneCodiceEAN128Righe" '<-- Specifica il campo chiave primaria
    
    'Crea un Link LEFT JOIN sulla tabella Articolo
    Set NewLink = m_DocumentsLink1.AddLink("IDRV_POIdentificatoreEAN128", "RV_POIdentificatoreEAN128", ltLeft, "IDRV_POIdentificatoreEAN128")
    NewLink.AddLinkColumn "RV_POIdentificatoreEAN128.Descrizione"

'************************************************************************************

    m_DocumentsLink1.AddOrderedColumn "PosizioneIdentificatore", ocAscending
    m_DocumentsLink1.AddOrderedColumn "Posizione", ocAscending
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Descrizione", "Descrizione", m_DocType.TableName, False, False, False, dgCondTypeText)
End Sub
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    If Me.GrigliaCorpo.ColumnsHeader.Count = 0 Then
        With Me.GrigliaCorpo.ColumnsHeader
            .Add "IDRV_POCostruzioneCodiceEAN128Righe", "IDRV_POCostruzioneCodiceEAN128Righe", dgInteger, False, 500, 0, True, True, False
            .Add "IDRV_POCostruzioneCodiceEAN128", "IDRV_POCostruzioneCodiceEAN128", dgInteger, False, 500, 0, True, True, False
            ...
            .Add "IDRV_POIdentificatoreEAN128", "IDRV_POIdentificatoreEAN128", dgInteger, False, 500, 0, True, True, False
            .Add "PosizioneIdentificatore", "Pos. ID.", dgNumeric, True, 1000, 0, True, True, False
            .Add "Posizione", "Posizione", dgNumeric, True, 1000, 0, True, True, False
            .Add "Descrizione", "Codice EAN128", dgchar, True, 4000, 0, True, True, False
            .Add "CodiceIdentificatoreEAN128", "Codice", dgchar, True, 2000, 0, True, True, False
            .Add "NomeCampoEtichetta", "Campo etichetta", dgchar, True, 2500, 0, True, True, False
            .Add "Valore", "Valore", dgchar, True, 1000, 0, True, True, False
...
'''''''''''''''''''''''''CONTROLLI STANDARD''''''''''''''''''''''''''''''''''''
    ...
    'Identificatore pedana
    With Me.cboIndetificatore
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_POIdentificatoreEAN128"
        .DisplayField = "Descrizione"
        .SQL = "SELECT * FROM RV_POIdentificatoreEAN128 "
        .SQL = .SQL & " ORDER BY Descrizione"
    End With
    
    'Tipo campo data
    With Me.cboTipoCampoEtichetta
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_POTipoCampoDataEtichetta"
        .DisplayField = "TipoCampoDataEtichetta"
        .SQL = "SELECT * FROM RV_POTipoCampoDataEtichetta "
        .SQL = .SQL & " ORDER BY TipoCampoDataEtichetta"
    End With

    'Identificatore EAN128
    ...
    LabelLink1.IDFunction = GET_FUNZIONE(GET_TIPO_OGGETTO("RV_POIdentificatioreEAN128"))
...
Private Sub cboIndetificatore_Click()
On Error Resume Next
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
    
    
    Me.cboTipoCampoEtichetta.Enabled = False
    Me.txtNumeroDecimali.Enabled = False
    
    
    sSQL = "SELECT Identificatore "
    sSQL = sSQL & "FROM RV_POIdentificatoreEAN128 "
    sSQL = sSQL & "WHERE IDRV_POIdentificatoreEAN128=" & Me.cboIndetificatore.CurrentID
    
    Set rs = Cn.OpenResultset(sSQL)
    
    If rs.EOF Then
        Me.txtCodiceIndentificatore.Text = ""
    Else
        Me.txtCodiceIndentificatore.Text = fnNotNull(rs!Identificatore)
            
        If fnNotNullN(rs!CampoData) = 1 Then
            Me.cboTipoCampoEtichetta.Enabled = True
        End If
        
        If fnNotNullN(rs!CampoConDecimali) = 1 Then
            Me.txtNumeroDecimali.Enabled = True
        End If
    End If
    
    If m_DocumentsLink1(m_DocumentsLink1.PrimaryKey) <= 0 Then
        If Me.cboIndetificatore.CurrentID > 0 Then
            Me.txtPosizioneIdentificatore.Value = GET_POSIZIONE(fnNotNullN(m_Document(m_Document.PrimaryKey).Value), Me.cboIndetificatore.CurrentID)
            
            Me.txtPosizione.Value = GET_POSIZIONE_CAMPO_PER_IDENTIFICATORE(fnNotNullN(m_Document(m_Document.PrimaryKey).Value), Me.cboIndetificatore.CurrentID)
        End If
    End If
...
Private Sub cmdCampiEtichetta_Click()
On Error GoTo ERR_cmdCampiEtichetta_Click
    frmCampiEtichetta.Show vbModal
    If GET_CONTROLLO_CAMPO_DATA(Me.txtCampoEtichetta.Text) = True Then
        Me.cboTipoCampoEtichetta.Enabled = True
    Else
        Me.cboTipoCampoEtichetta.Enabled = False
        Me.cboTipoCampoEtichetta.WriteOn 0
    End If
Exit Sub
ERR_cmdCampiEtichetta_Click:
    MsgBox Err.Description, vbCritical, "cmdCampiEtichetta_Click"
End Sub
...
Testo = "Sei sicuro di voler eliminare la riga?"
    ...
    Me.txtStringaCodiceEAN128.Text = GET_COSTRUZIONE_STRINGA(m_Document(m_Document.PrimaryKey).Value)
...
Private Sub cmdNuovo_Click()
    If m_Document(m_Document.PrimaryKey).Value <= 0 Then
        MsgBox "Salvare il documento per poter inserire le righe di costruzione", vbInformation, "Costruzione codice EAN128"
        Exit Sub
    End If
...
Private Sub cmdNuovoiID_Click()
    Me.LabelLink1.IDReturn = Me.cboIndetificatore.CurrentID
...
On Error GoTo ERR_cmdSalva_Click
    ...
    If Me.cboIndetificatore.CurrentID = 0 Then
        MsgBox "Inserire identificatore", vbCritical, "Salvataggio riga"
        Exit Sub
    End If
    
    
        
    m_DocumentsLink1("IDRV_POIdentificatoreEAN128").Value = Me.cboIndetificatore.CurrentID
    m_DocumentsLink1("CodiceIdentificatoreEAN128").Value = Me.txtCodiceIndentificatore.Text
    m_DocumentsLink1("IDAzienda").Value = TheApp.IDFirm
    m_DocumentsLink1("IDFiliale").Value = TheApp.Branch
    m_DocumentsLink1("NomeCampoEtichetta").Value = Me.txtCampoEtichetta.Text
    m_DocumentsLink1("Valore").Value = Me.txtValoreManuale.Text
    m_DocumentsLink1("Posizione").Value = Me.txtPosizione.Value
    m_DocumentsLink1("PosizioneIdentificatore").Value = Me.txtPosizioneIdentificatore.Value
    m_DocumentsLink1("IDRV_POTipoCampoDataEtichetta").Value = Me.cboTipoCampoEtichetta.CurrentID
    m_DocumentsLink1("NumeroDecimali").Value = Me.txtNumeroDecimali.Value
    
    m_DocumentsLink1.Save
    
    AGGIORNA_POSIZIONE_IDENTIFICATORE m_Document(m_Document.PrimaryKey).Value, Me.cboIndetificatore.CurrentID, Me.txtPosizioneIdentificatore.Value
...
Private Sub LabelLink1_AfterRunServerApplication(ByVal lIDResultKey As Long)
    If lIDResultKey > 0 Then
        Me.cboIndetificatore.WriteOn fnNotNullN(lIDResultKey)
    End If
...
'            End If
    ...
    'rif11 begin
       ...
       On Error Resume Next
        ...
        Me.txtStringaCodiceEAN128.Text = GET_COSTRUZIONE_STRINGA(fnNotNullN(m_Document(m_Document.PrimaryKey).Value))
End Sub
...
Private Sub m_DocumentsLink1_OnReposition()
 ...
 On Error Resume Next
    ...
    If Not (m_DocumentsLink1.BOF And m_DocumentsLink1.EOF) Then
        ...
        Me.cboIndetificatore.WriteOn fnNotNullN(m_DocumentsLink1("IDRV_POIdentificatoreEAN128").Value)
        Me.txtCodiceIndentificatore.Text = fnNotNull(m_DocumentsLink1("CodiceIdentificatoreEAN128").Value)
        Me.txtCampoEtichetta.Text = fnNotNull(m_DocumentsLink1("NomeCampoEtichetta").Value)
        Me.txtValoreManuale.Text = fnNotNull(m_DocumentsLink1("Valore").Value)
        Me.txtPosizione.Value = fnNotNullN(m_DocumentsLink1("Posizione").Value)
        Me.txtPosizioneIdentificatore.Value = fnNotNullN(m_DocumentsLink1("PosizioneIdentificatore").Value)
        Me.cboTipoCampoEtichetta.WriteOn fnNotNullN(m_DocumentsLink1("IDRV_POTipoCampoDataEtichetta").Value)
        Me.txtNumeroDecimali.Value = fnNotNullN(m_DocumentsLink1("NumeroDecimali").Value)
        bValue = True
    ...
    Else
        ...
        Me.cboIndetificatore.WriteOn 0
        Me.txtCodiceIndentificatore.Text = ""
        Me.txtCampoEtichetta.Text = ""
        Me.txtValoreManuale.Text = ""
        Me.txtPosizione.Value = 0
        Me.txtPosizioneIdentificatore.Value = 0
        Me.cboTipoCampoEtichetta.WriteOn 0
        Me.txtNumeroDecimali.Value = 0
    ...
    'Abilita/disabilita i controlli a seconda che ci sia o meno almeno un sottodocumento
        Me.cboIndetificatore.Enabled = bValue
        'Me.txtCodiceIndentificatore.Enabled = bValue
        'Me.txtCampoEtichetta.Enabled = bValue
        Me.txtValoreManuale.Enabled = bValue
        Me.txtPosizione.Enabled = bValue
        Me.txtPosizioneIdentificatore.Enabled = bValue
        GET_CONTROLLO_CAMPO_DATA Me.txtCampoEtichetta.Text
        Me.txtNumeroDecimali.Enabled = bValue
...
End Sub
Private Function GET_COSTRUZIONE_STRINGA(IDTestaConfigurazione As Long)
On Error GoTo ERR_GET_COSTRUZIONE_STRINGA
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
Dim rsTesta As DmtOleDbLib.adoResultset

sSQL = "SELECT IDRV_POIdentificatoreEAN128, CodiceIdentificatoreEAN128, PosizioneIdentificatore "
sSQL = sSQL & "FROM RV_POCostruzioneCodiceEAN128Righe "
sSQL = sSQL & "WHERE (IDRV_POCostruzioneCodiceEAN128 = " & IDTestaConfigurazione & ") "
sSQL = sSQL & "GROUP BY IDRV_POIdentificatoreEAN128, CodiceIdentificatoreEAN128, PosizioneIdentificatore "
sSQL = sSQL & "ORDER BY PosizioneIdentificatore "

Set rsTesta = Cn.OpenResultset(sSQL)
GET_COSTRUZIONE_STRINGA = ""

While Not rsTesta.EOF

    If Len(fnNotNull(rsTesta!CodiceIdentificatoreEAN128)) > 0 Then
        GET_COSTRUZIONE_STRINGA = GET_COSTRUZIONE_STRINGA & "(" & rsTesta!CodiceIdentificatoreEAN128 & ")"
    End If
    ...
    While Not rs.EOF
        ...
        If Len(fnNotNull(rs!NomeCampoEtichetta)) > 0 Then
            GET_COSTRUZIONE_STRINGA = GET_COSTRUZIONE_STRINGA & "[" & fnNotNull(rs!NomeCampoEtichetta) & "]"
        End If
        If Len(fnNotNull(rs!Valore)) > 0 Then
            GET_COSTRUZIONE_STRINGA = GET_COSTRUZIONE_STRINGA & "[" & fnNotNull(rs!Valore) & "]"
        End If
    rs.MoveNext
    Wend
...
rsTesta.CloseResultset
Set rsTesta = Nothing


Exit Function
ERR_GET_COSTRUZIONE_STRINGA:
    MsgBox Err.Description, vbCritical, "GET_COSTRUZIONE_STRINGA"

End Function
Private Function GET_POSIZIONE(IDTestaCostruzione As Long, IDIDentificatore As Long) As Long
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
Dim rsPos As DmtOleDbLib.adoResultset


sSQL = "SELECT PosizioneIdentificatore "
sSQL = sSQL & "FROM RV_POCostruzioneCodiceEAN128Righe "
sSQL = sSQL & "WHERE IDRV_POCostruzioneCodiceEAN128=" & IDTestaCostruzione
sSQL = sSQL & " AND IDRV_POIdentificatoreEAN128=" & IDIDentificatore

Set rsPos = Cn.OpenResultset(sSQL)

If rsPos.EOF Then
    
    sSQL = "SELECT MAX(PosizioneIdentificatore) AS PosizioneIdentificatore "
    sSQL = sSQL & "FROM RV_POCostruzioneCodiceEAN128Righe "
    sSQL = sSQL & "WHERE IDRV_POCostruzioneCodiceEAN128=" & IDTestaCostruzione
    ...
    If rs.EOF Then
        GET_POSIZIONE = 1
    Else
        GET_POSIZIONE = fnNotNullN(rs!PosizioneIdentificatore) + 1
    End If
    
    rs.CloseResultset
    Set rs = Nothing
Else
    GET_POSIZIONE = fnNotNullN(rsPos!PosizioneIdentificatore)
End If

rsPos.CloseResultset
Set rsPos = Nothing
End Function
Private Function GET_POSIZIONE_CAMPO_PER_IDENTIFICATORE(IDTestaCostruzione As Long, IDIDentificatore As Long) As Long
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT MAX(Posizione) AS Posizione "
sSQL = sSQL & "FROM RV_POCostruzioneCodiceEAN128Righe "
sSQL = sSQL & "WHERE IDRV_POCostruzioneCodiceEAN128=" & IDTestaCostruzione
sSQL = sSQL & " AND IDRV_POIdentificatoreEAN128=" & IDIDentificatore
...
If rs.EOF Then
    GET_POSIZIONE_CAMPO_PER_IDENTIFICATORE = 1
Else
    GET_POSIZIONE_CAMPO_PER_IDENTIFICATORE = fnNotNullN(rs!Posizione) + 1
End If
...
Private Sub AGGIORNA_POSIZIONE_IDENTIFICATORE(IDTestaCostruzione As Long, IDIDentificatore As Long, Posizione As Long)
Dim sSQL As String


sSQL = "UPDATE RV_POCostruzioneCodiceEAN128Righe SET "
sSQL = sSQL & "PosizioneIdentificatore=" & Posizione
sSQL = sSQL & " WHERE IDRV_POCostruzioneCodiceEAN128=" & IDTestaCostruzione
sSQL = sSQL & " AND IDRV_POIdentificatoreEAN128=" & IDIDentificatore
...
Private Function GET_CONTROLLO_CAMPO_DATA(NomeCampo As String) As Boolean
On Error GoTo ERR_GET_CONTROLLO_CAMPO_DATA
If NomeCampo = "" Then
    GET_CONTROLLO_CAMPO_DATA = False
    Exit Function
End If
Dim rs As ADODB.Recordset

If Len(Trim(NomeCampo)) = 0 Then
    GET_CONTROLLO_CAMPO_DATA = False
End If
...
Select Case rs.Fields(NomeCampo).Type
    Case adDate, adDBDate, adDBTime, adDBTimeStamp
        GET_CONTROLLO_CAMPO_DATA = True
    Case Else
        GET_CONTROLLO_CAMPO_DATA = False
End Select
...
Exit Function
ERR_GET_CONTROLLO_CAMPO_DATA:
    MsgBox Err.Description, vbCritical, "GET_CONTROLLO_CAMPO_DATA"
End Function
