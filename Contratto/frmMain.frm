      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               Tab(0).Control(0)=   "FraTab(7)"
               Tab(0).Control(1)=   "FraTab(2)"
               Tab(0).Control(2)=   "FraTab(0)"
               Tab(0).Control(3)=   "FraTab(5)"
               Tab(0).Control(4)=   "FraTab(4)"
               Tab(0).Control(5)=   "FraTab(8)"
               Tab(0).Control(6)=   "Frame1"
               Tab(0).Control(7)=   "FraTab(1)"
               Tab(0).Control(8)=   "Frame3"
               Tab(0).Control(9)=   "cboCambioValuta"
               Tab(0).Control(10)=   "txtValoreCambioValuta"
               Tab(0).Control(11)=   "txtDataCambio"
               ...
               Begin VB.Frame FraTab 
                  ...
                  Begin VB.Frame fraAnnotazioni 
                     Caption         =   "Note per riga di ordine"
                     BeginProperty Font 
                        Name            =   "Tahoma"
                        Size            =   8.25
                        Charset         =   0
                  ...
                  Begin VB.Frame fraArticoli 
                     ...
                     Begin DmtCodDescCtl.DmtCodDesc CDArticolo 
                        ...
                        BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                           ...
                           Strikethrough   =   0   'False
                        EndProperty
                        PropDescrizione =   $"frmMain.frx":481B2
                        BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                           Name            =   "Arial"
                           Size            =   8.25
                           Charset         =   0
                           ...
                           Strikethrough   =   0   'False
                        EndProperty
                        MenuFunctions   =   $"frmMain.frx":48209
                        BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                           Name            =   "Tahoma"
                           Size            =   8.25
                           Charset         =   0
                  ...
                  Begin VB.Frame Frame8 
                     ...
                     End
                  End
                  Begin VB.Frame FraParametriQualitaRiga 
                     Height          =   855
                     Left            =   120
                     TabIndex        =   272
                     Top             =   3240
                     ...
                     Begin VB.CommandButton Command1 
                        Caption         =   "Quantità per cooperativa/socio diretto"
                        Height          =   525
                        Left            =   14280
                        TabIndex        =   309
                        TabStop         =   0   'False
                        ...
                        Width           =   2265
                     End
                     Begin DMTEDITNUMLib.dmtNumber txtVarPercPiu 
                        Height          =   315
                        Left            =   2880
                        TabIndex        =   103
                        Top             =   360
                        ...
                        AllowEmpty      =   0   'False
                     End
                     Begin DMTEDITNUMLib.dmtNumber txtVarPercMeno 
                        Height          =   315
                        Left            =   4320
                        TabIndex        =   104
                        Top             =   360
                        ...
                        AllowEmpty      =   0   'False
                     End
                     Begin DMTEDITNUMLib.dmtNumber txtVarImpPiu 
                        Height          =   315
                        Left            =   5760
                        TabIndex        =   105
                        Top             =   360
                        ...
                        AllowEmpty      =   0   'False
                     End
                     Begin DMTEDITNUMLib.dmtNumber txtVarImpMeno 
                        Height          =   315
                        Left            =   7200
                        TabIndex        =   106
                        Top             =   360
                        ...
                        AllowEmpty      =   0   'False
                     End
                     Begin DMTEDITNUMLib.dmtNumber txtImportoMassimo 
                        Height          =   315
                        Left            =   8640
                        TabIndex        =   107
                        Top             =   360
                        ...
                        AllowEmpty      =   0   'False
                     End
                     Begin DMTEDITNUMLib.dmtNumber txtImportoMinimo 
                        Height          =   315
                        Left            =   10080
                        TabIndex        =   108
                        Top             =   360
                        ...
                        AllowEmpty      =   0   'False
                     End
                     Begin DMTDATETIMELib.dmtDate txtDataInizioCons 
                        Height          =   315
                        Left            =   120
                        TabIndex        =   101
                        Top             =   360
                        ...
                        Appearance      =   1
                     End
                     Begin DMTDATETIMELib.dmtDate txtDataFineCons 
                        Height          =   315
                        Left            =   1560
                        TabIndex        =   102
                        Top             =   360
                        ...
                        Appearance      =   1
                     End
                     Begin DMTEDITNUMLib.dmtNumber txtQtaCertificato 
                        Height          =   315
                        Left            =   11520
                        TabIndex        =   310
                        Top             =   360
               ...
               Begin VB.Frame Frame1 
                  ...
                  Begin DmtCodDescCtl.DmtCodDesc CDAgenteTesta 
                     ...
                     BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     PropDescrizione =   $"frmMain.frx":485BE
                     BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Tahoma"
                        Size            =   8.25
                        Charset         =   0
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     MenuFunctions   =   $"frmMain.frx":4860F
                     BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Tahoma"
                        Size            =   8.25
                        Charset         =   0
               ...
               Begin VB.Frame FraTab 
                  ...
                  Begin DmtCodDescCtl.DmtCodDesc cdAnagrafica 
                     ...
                     BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     PropDescrizione =   $"frmMain.frx":486CD
                     BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Tahoma"
                        Size            =   8.25
                        Charset         =   0
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     MenuFunctions   =   $"frmMain.frx":4871E
                     BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Tahoma"
                        Size            =   8.25
                        Charset         =   0
...
Dim Testo As String
    ...
    If dtData.Value = 0 Then
        ...
        Exit Function
    End If
    If DATA_SCADENZA_OBBLIGATORIA = 1 Then
        If Me.txtDataScadenza.Value = 0 Then
            sbMsgInfo "La data di scadenza del contratto è obbligatoria", m_App.FunctionName
            Exit Function
        End If
    End If
    If Me.txtDataScadenza.Value > 0 Then
        If Me.txtDataScadenza.Value < Me.dtData.Value Then
            MsgBox "La data scadenza non può essere minore della data di inizio validità", vbCritical, "Controllo dati"
            PermissionToSave = False
    ...
    End If
    If oDoc.IDOggetto <= 0 Then
        If GET_CONTROLLO_DATE_SOVRAPPOSTE(dtData.Text, txtDataScadenza.Text, 2) = True Then
            Testo = "ATTENZIONE!!!" & vbCrLf
            Testo = Testo & "Risulta un contratto sempre valido ancora non chiuso" & vbCrLf
            Testo = Testo & "Vuoi continuare a salvare il documento?"
        ...
        If GET_CONTROLLO_DATE_SOVRAPPOSTE(dtData.Text, txtDataScadenza.Text, 1) = True Then
            Testo = "ATTENZIONE!!!" & vbCrLf
            Testo = Testo & "Nel range di date risulta un contratto attivo" & vbCrLf
            Testo = Testo & "Vuoi continuare a salvare il documento?"
            If MsgBox(Testo, vbQuestion + vbYesNo, "Validazione dati") = vbNo Then
                PermissionToSave = False
                Exit Function
...
'    m_Semaphore.SetObjectAction m_DocType.ID, SemAllObjects, SemInsertAction
    ...
    oDoc.Field "Doc_data_scadenza", Null, sTabellaTestata
    'Imposta la data con la data di sistema
    oDoc.Field "Doc_data", Date, sTabellaTestata
    'If (DATA_SCADENZA_OBBLIGATORIA = 1) Then oDoc.Field "Doc_data_scadenza", Date, sTabellaTestata
    If GG_DATA_SCADENZA > 0 Then
        oDoc.Field "Doc_data_scadenza", DateAdd("d", GG_DATA_SCADENZA - 1, Date), sTabellaTestata
    End If
    ...
    RECUPERO_PAR_QUAL_CONTR oDoc.IDOggetto
...
Private Sub ExecuteMenuCommand(ByVal sToolName As String)
    ...
    Select Case sToolName
        ...
        Case "cmdImputazionePrezzi"
            cmdImputazionePrezzi_Click
        Case "Command2"
            Command2_Click
        Case "Command1"
            Command1_Click
...
'    ACSSocio.HwndContainer = Me.hwnd
    ...
    With lvwArticoli
        ...
        .ColumnHeaders.Add , , "ID Art.", 100                       '02
        .ColumnHeaders.Add , , "Cod. Articolo", 1000                '03
        .ColumnHeaders.Add , , "Articolo", 2000                     '04
        .ColumnHeaders.Add , , "Q.tà", 1000, lvwColumnRight         '05
        .ColumnHeaders.Add , , "Imp. Unit.", 1000, lvwColumnRight   '06
        .ColumnHeaders.Add , , "Sc. 1", 700, lvwColumnRight         '07
        .ColumnHeaders.Add , , "Sc. 2", 700, lvwColumnRight         '08
        .ColumnHeaders.Add , , "Imp.Un.Net.", 1000, lvwColumnRight  '09
        
        .ColumnHeaders.Add , , "IDImballoPrimario", 100, lvwColumnLeft   '10
        .ColumnHeaders.Add , , "Codice imballo primario", 1300, lvwColumnLeft   '11
        .ColumnHeaders.Add , , "Descrizione imballo primario", 2000, lvwColumnLeft   '12
        
        .ColumnHeaders.Add , , "ID Art. Ped.", 100                  '13
        .ColumnHeaders.Add , , "Codice Pedanda", 1000               '14
        .ColumnHeaders.Add , , "Pedana", 2000                       '15
        .ColumnHeaders.Add , , "Q.tà pedana", 1000, lvwColumnRight  '16
        .ColumnHeaders.Add , , "ID Tipo U.M. riga.", 100            '17
        .ColumnHeaders.Add , , "U.M. riga", 1000                    '18
        
        
        
        .ColumnHeaders.Add , , "Colli", 800, lvwColumnRight         '19
        .ColumnHeaders.Add , , "Pezzi", 1000, lvwColumnRight        '20
        .ColumnHeaders.Add , , "Peso lordo", 1000, lvwColumnRight   '21
        .ColumnHeaders.Add , , "Tara", 1000, lvwColumnRight         '22
        '.ColumnHeaders.Add , , "Cod. IVA", 1000, lvwColumnRight
        .ColumnHeaders.Add , , "% IVA", 500, lvwColumnRight         '23
        .ColumnHeaders.Add , , "Netto riga", 1300, lvwColumnRight   '24
        .ColumnHeaders.Add , , "Lordo riga", 1300, lvwColumnRight   '25
        
        .ColumnHeaders.Add , , "Raggrup. ord.", 1300, lvwColumnLeft   '26
        .ColumnHeaders.Add , , "Categoria", 1300, lvwColumnLeft   '27
        .ColumnHeaders.Add , , "Calibro", 1300, lvwColumnLeft   '28
        .ColumnHeaders.Add , , "Tipo lavorazione", 1300, lvwColumnLeft   '29
...
Private Sub CreateBrowserConditions()
    ...
    BrwMain.Conditions("Group1").IsHeader = True
        Set Cond = BrwMain.Conditions.Add("Doc_data", "Data inizio validità", m_DocType.TableName, False, True, , dgCondTypeDate)
            Cond.Indentation = 20
        ...
        Set Cond = BrwMain.Conditions.Add("Link_Nom_raggrup_fatturato", "Raggruppamento fatturato", m_DocType.TableName, False, False, , dgCondTypeComboDB)
           Cond.Indentation = 20
    ...
    BrwMain.Conditions.Add "Group2", "Riferimenti contratto", ""
    BrwMain.Conditions("Group2").IsHeader = True
        Set Cond = BrwMain.Conditions.Add("RV_POContrattoChiuso", "Contratto chiuso", m_DocType.TableName, False, False, , dgCondTypeBoolean)
            Cond.FromValue = "NO"
            Cond.Indentation = 20
        Set Cond = BrwMain.Conditions.Add("Doc_data_scadenza", "Data scadenza", m_DocType.TableName, False, True, , dgCondTypeDate)
            Cond.Indentation = 20
            Cond.RangeChecked = True
        Set Cond = BrwMain.Conditions.Add("Doc_data_vs_ordine_di_rifer", "Data presso cliente", m_DocType.TableName, False, True, , dgCondTypeDate)
            Cond.Indentation = 20
        Set Cond = BrwMain.Conditions.Add("Doc_numero_vs_ordine_di_rifer", "Numero presso cliente", m_DocType.TableName, False, True, , dgCondTypeText)
            Cond.Indentation = 20
        Set Cond = BrwMain.Conditions.Add("Doc_descrizione_offerta", "Descrizione contratto", m_DocType.TableName, False, False, , dgCondTypeText)
            Cond.Indentation = 20
           
    BrwMain.Conditions.Add "Group3", "Altre destinazioni", ""
...
Private Sub InitToolBar(ByRef ToolID As Integer)
    ...
    ToolID = ToolID + 1
    BarMenu.Bands("StandardPO").Tools.Add ToolID, "cmdImputazionePrezzi"
    BarMenu.Bands("StandardPO").Tools("cmdImputazionePrezzi").Style = ddSIconText
    BarMenu.Bands("StandardPO").Tools("cmdImputazionePrezzi").SetPicture 0, gResource.GetBitmap(IDB_ARTICOLI_DA_ASSEGNARE16), &HC0C0C0
    BarMenu.Bands("StandardPO").Tools("cmdImputazionePrezzi").ToolTipText = "Imputazione prezzi" '"GetCaption4MenuBar("Mnu_FormView")
    BarMenu.Bands("StandardPO").Tools("cmdImputazionePrezzi").Description = "Imputazione prezzi"  'GetDescription4StatusBar("Mnu_FormView")
    BarMenu.Bands("StandardPO").Tools("cmdImputazionePrezzi").Caption = "Imputazione prezzi"  'GetDescription4StatusBar("Mnu_FormView")
    ToolID = ToolID + 1
    BarMenu.Bands("StandardPO").Tools.Add ToolID, "Sep12"
    BarMenu.Bands("StandardPO").Tools("Sep12").ControlType = ddTTSeparator
    
    ToolID = ToolID + 1
    BarMenu.Bands("StandardPO").Tools.Add ToolID, "Command1"
    BarMenu.Bands("StandardPO").Tools("Command1").Style = ddSIconText
    BarMenu.Bands("StandardPO").Tools("Command1").SetPicture 0, gResource.GetBitmap(IDB_FORMULE16), &HC0C0C0
    BarMenu.Bands("StandardPO").Tools("Command1").ToolTipText = "Q.tà contratto per cooperativa" '"GetCaption4MenuBar("Mnu_FormView")
    BarMenu.Bands("StandardPO").Tools("Command1").Description = "Q.tà contratto per cooperativa"  'GetDescription4StatusBar("Mnu_FormView")
    BarMenu.Bands("StandardPO").Tools("Command1").Caption = "Q.tà contratto per cooperativa"  'GetDescription4StatusBar("Mnu_FormView")
    ToolID = ToolID + 1
    ...
    ToolID = ToolID + 1
    BarMenu.Bands("StandardPO").Tools.Add ToolID, "Command2"
    BarMenu.Bands("StandardPO").Tools("Command2").Style = ddSIconText
    BarMenu.Bands("StandardPO").Tools("Command2").SetPicture 0, gResource.GetBitmap(IDB_COLLO_QTA_PRELEVATA_REFRESH16), &HC0C0C0
    BarMenu.Bands("StandardPO").Tools("Command2").ToolTipText = "Elenco certificati" '"GetCaption4MenuBar("Mnu_FormView")
    BarMenu.Bands("StandardPO").Tools("Command2").Description = "Elenco certificati"  'GetDescription4StatusBar("Mnu_FormView")
    BarMenu.Bands("StandardPO").Tools("Command2").Caption = "Elenco certificati"  'GetDescription4StatusBar("Mnu_FormView")
    ToolID = ToolID + 1
...
On Error GoTo ERR_fnFillDocTypeCondition
    Dim Field As DmtDocManLib.Field
    Dim Cond As DmtGridCtl.dgCondition
    Dim sWhere As String
...
Exit Function
ERR_fnFillDocTypeCondition:
    MsgBox Err.Description, vbCritical, "fnFillDocTypeCondition"
End Function
...
'        End If
    ...
    If oDoc.LastErrorNumber = 0 Then
        ...
        SALVA_PAR_QUAL_CONTR oDoc.IDOggetto
...
'    End If
    ...
    If fnMsgQuestion(gResource.GetCustomizedMessage(MESS_QUERYREMOVE), m_App.FunctionName) = vbYes Then
        ...
        If oDoc.DeleteWithTO(oDoc.IDOggetto, oDoc.IDTipoOggetto) <> 0 Then
            ...
            ELIMINA_PAR_QUAL_CONTR Link_Oggetto
...
Private Sub cmdNuovo_Click()
    ...
    Me.txtQuantitaPerPedana.Value = 0
...
'    Me.txtAnnotazioniPerSocio.Text = ""
    ...
    Me.txtDataInizioCons.Value = 0
    Me.txtDataFineCons.Value = 0
    Me.txtVarPercPiu.Value = Me.txtQual15.Value
    Me.txtVarPercMeno.Value = Me.txtQual01.Value
    Me.txtVarImpPiu.Value = 0
    Me.txtVarImpMeno.Value = 0
...
Private Sub cmdImputazionePrezzi_Click()
    If oDoc.IDOggetto > 0 Then
...
Private Sub Command1_Click()
    If oDoc.IDOggetto = 0 Then Exit Sub
    If m_Changed = True Then
        MsgBox "Salvare il documento prima di procedere con questo comando!", vbInformation, "Controllo dati"
        Exit Sub
    End If
    
    frmQuantitaPerSocio.Show vbModal
    If ChangeDatiQtaPerSocio = 1 Then If Not (BrwMain.Visible) Then Change
End Sub

Private Sub Command2_Click()
    
    'IDValoriOggettoDettaglioSel = NumeroRecordPerModifica

    frmElencoCertificatiCollegati.Show vbModal
...
Dim IDPagamento As Long
    ...
    If Me.dtData.Text <> oDoc.Field("Doc_data", , sTabellaTestata) Then
        ...
        End If
        If GG_DATA_SCADENZA > 0 Then
            oDoc.Field "Doc_data_scadenza", DateAdd("d", GG_DATA_SCADENZA - 1, dtData.Text), sTabellaTestata
        End If
...
Private Sub lvwArticoli_ItemClick(ByVal Item As MSComctlLib.ListItem)
    ...
    Me.txtQtaCertificato.Value = CALCOLA_TOTALE_CERTIFICATO
...
'            Me.chkOrdineCompletato.Value = Value
        ...
        Case "Doc_data_vs_ordine_di_rifer"
            Me.txtDataOrdineCliente.Value = fnNotNullN(Value)
        Case "Doc_numero_vs_ordine_di_rifer"
            Me.txtNumeroOrdineCliente.Text = fnNotNull(Value)
        Case "RV_POContrattoChiuso"
            Me.chkChiuso.Value = Abs(fnNotNullN(Value))
        Case "Doc_data_scadenza"
            Me.txtDataScadenza.Value = fnNotNullN(Value)
        Case "Doc_descrizione_offerta"
            Me.txtDescrizioneContratto.Text = fnNotNull(Value)
    ...
    With oDoc.Tables(sTabellaDettaglio)
        ...
        For lRow = 1 To .NumRetails
            Set oItem = lvwArticoli.ListItems.Add
                ...
                End If
                oItem.SubItems(10) = fnNotNullN(.Fields("RV_POIDImballoPrimario").Values(lRow).Value)
                oItem.SubItems(11) = fnNotNull(.Fields("RV_POCodiceImballoPrimario").Values(lRow).Value)
                oItem.SubItems(12) = fnNotNull(.Fields("RV_PODescrizioneImballoPrimario").Values(lRow).Value)
                
                oItem.SubItems(13) = fnNotNullN(.Fields("RV_POIDArticoloPedana").Values(lRow).Value)
                oItem.SubItems(14) = fnNotNull(.Fields("RV_POCodiceArticoloPedana").Values(lRow).Value)
                oItem.SubItems(15) = fnNotNull(.Fields("RV_PODescrizioneArticoloPedana").Values(lRow).Value)
                oItem.SubItems(16) = fnNotNullN(.Fields("RV_POQuantitaPedana").Values(lRow).Value)
                oItem.SubItems(17) = fnNotNull(.Fields("RV_POIDTipoUMOrdine").Values(lRow).Value)
                oItem.SubItems(18) = fnNotNull(.Fields("RV_POTipoUMOrdine").Values(lRow).Value)

                oItem.SubItems(19) = fnNotNullN(.Fields("Art_numero_colli").Values(lRow).Value)
                oItem.SubItems(20) = FormatNumber(fnNotNullN(.Fields("Art_quantita_pezzi").Values(lRow).Value), 2)
                oItem.SubItems(21) = FormatNumber(fnNotNullN(.Fields("Art_peso").Values(lRow).Value), 2)
                oItem.SubItems(22) = FormatNumber(fnNotNullN(.Fields("Art_tara").Values(lRow).Value), 2)
                oItem.SubItems(23) = fnNotNullN(.Fields("Art_aliquota_IVA").Values(lRow).Value)
                oItem.SubItems(24) = FormatNumber(fnNotNullN(.Fields("Art_importo_totale_netto_IVA").Values(lRow).Value), 2)
                oItem.SubItems(25) = FormatNumber(fnNotNullN(.Fields("Art_importo_totale_lordo_IVA").Values(lRow).Value), 2)
                oItem.SubItems(26) = fnNotNull(.Fields("RV_PONotaRigaOrdRaggr").Values(lRow).Value)
                oItem.SubItems(27) = GET_DESCRIZIONE_TABELLA(2, fnNotNullN(.Fields("RV_POIDTipoCategoria").Values(lRow).Value))
                oItem.SubItems(28) = GET_DESCRIZIONE_TABELLA(1, fnNotNullN(.Fields("RV_POIDCalibro").Values(lRow).Value))
                oItem.SubItems(29) = GET_DESCRIZIONE_TABELLA(3, fnNotNullN(.Fields("RV_POIDTipoLavorazione").Values(lRow).Value))
...
Private Sub sbVariazioneRiga()
    ...
    If Not lvwArticoli.SelectedItem Is Nothing Then
        ...
        If oDoc.Field("RV_POTipoRiga", , sTabellaDettaglio) = 1 Then
            ...
            Me.txtAnnotazioniDiRigaLav = fnNotNull(oDoc.Field("RV_POAnnotazioniRigaLavorazione", , sTabellaDettaglio))
            Me.txtIDRigaContratto.Value = fnNotNullN(oDoc.Field("RV_POIDValoriOggettoDettaglioContratto", , sTabellaDettaglio))
...
'            Me.txtAnnotazioniPerSocio.Text = fnNotNull(oDoc.Field("RV_PO01_AnnotazioniSocio", , sTabellaDettaglio))
            ...
            'VARIAZIONI
            Me.txtDataInizioCons.Value = fnNotNullN(oDoc.Field("RV_PODataInizioConsegna", , sTabellaDettaglio))
            Me.txtDataFineCons.Value = fnNotNullN(oDoc.Field("RV_PODataFineConsegna", , sTabellaDettaglio))
            Me.txtVarPercPiu.Value = fnNotNullN(oDoc.Field("RV_POVariazionePercMax", , sTabellaDettaglio))
            Me.txtVarPercMeno.Value = fnNotNullN(oDoc.Field("RV_POVariazionePercMin", , sTabellaDettaglio))
            Me.txtVarImpPiu.Value = fnNotNullN(oDoc.Field("RV_POVariazioneImportoMax", , sTabellaDettaglio))
            Me.txtVarImpMeno.Value = fnNotNullN(oDoc.Field("RV_POVariazioneImportoMin", , sTabellaDettaglio))
            Me.txtImportoMassimo.Value = fnNotNullN(oDoc.Field("RV_POImportoUnitarioMax", , sTabellaDettaglio))
            Me.txtImportoMinimo.Value = fnNotNullN(oDoc.Field("RV_POImportoUnitarioMin", , sTabellaDettaglio))

            
            IDArtDettaglioProgSEL = fnNotNullN(oDoc.Field("ID_Art_dettaglio_prog", , sTabellaDettaglio))
...
Private Sub sbImpostaDatiDocumento()
    ...
    'RIFERIMENTO CONTRATTO/OFFERTA''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    If Me.txtDataOrdineCliente.Value > 0 Then
        oDoc.Field "Doc_data_vs_ordine_di_rifer", Me.txtDataOrdineCliente.Value, sTabellaTestata
    Else
        oDoc.Field "Doc_data_vs_ordine_di_rifer", Null, sTabellaTestata
    End If
    oDoc.Field "Doc_numero_vs_ordine_di_rifer", Me.txtNumeroOrdineCliente.Text, sTabellaTestata
    oDoc.Field "RV_POContrattoChiuso", Me.chkChiuso.Value, sTabellaTestata
    If Me.txtDataScadenza.Value = 0 Then
        oDoc.Field "Doc_data_scadenza", Null, sTabellaTestata
    Else
        oDoc.Field "Doc_data_scadenza", Me.txtDataScadenza.Value, sTabellaTestata
    End If
    oDoc.Field "Doc_descrizione_offerta", Me.txtDescrizioneContratto.Text, sTabellaTestata
    ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
While Not rs.EOF
    ...
    Else
        ImportoListinoImballo = GET_PREZZO_IMBALLO_PER_COMMMISSIONI(fnNotNullN(rs!RV_POIDImballo), Me.cboListino.CurrentID)
...
sSQL = "SELECT IDRV_POTipoUMOrdine FROM RV_POSchemaCoop WHERE ("
sSQL = sSQL & "(IDFiliale=" & m_App.Branch & ") "
sSQL = sSQL & "AND (IDUtente=0))"
...
Private Sub txtDataScadenza_LostFocus()
    sbImpostaDatiDocumento
End Sub
...
Private Sub txtDescrizioneContratto_LostFocus()
    sbImpostaDatiDocumento
End Sub
...
Dim TOT_IMBALLO As Double
    ...
    'Totale variazioni
    Me.txtImportoMassimo.Value = Me.txtImponibileUnitario.Value + ((Me.txtImponibileUnitario.Value / 100) * Me.txtVarPercPiu.Value)
    Me.txtImportoMassimo.Value = Me.txtImportoMassimo.Value + Me.txtVarImpPiu.Value
    
    Me.txtImportoMinimo.Value = Me.txtImponibileUnitario.Value - ((Me.txtImponibileUnitario.Value / 100) * Me.txtVarPercMeno.Value)
    Me.txtImportoMinimo.Value = Me.txtImportoMinimo.Value - Me.txtVarImpMeno.Value
...
End If
    ...
    If Me.CDArticolo.KeyFieldID > 0 Then
            ...
            oDoc.Field "RV_PODescrizioneDocumento", "Rif. contratto n: /" & GetNumeroDocumentoModificato(Me.lngNumero.Value) & " del " & Me.dtData.Text, sTabellaDettaglio
...
'            oDoc.Field "RV_PO01_AnnotazioniSocio", Me.txtAnnotazioniPerSocio.Text, sTabellaDettaglio
            ...
            'VARIAZIONI
            If Me.txtDataInizioCons.Value > 0 Then
                oDoc.Field "RV_PODataInizioConsegna", Me.txtDataInizioCons.Value, sTabellaDettaglio
            Else
                oDoc.Field "RV_PODataInizioConsegna", Null, sTabellaDettaglio
            End If
            If Me.txtDataFineCons.Value > 0 Then
                oDoc.Field "RV_PODataFineConsegna", Me.txtDataFineCons.Value, sTabellaDettaglio
            Else
                oDoc.Field "RV_PODataFineConsegna", Null, sTabellaDettaglio
            End If
            oDoc.Field "RV_POVariazionePercMax", Me.txtVarPercPiu.Value, sTabellaDettaglio
            oDoc.Field "RV_POVariazionePercMin", Me.txtVarPercMeno.Value, sTabellaDettaglio
            oDoc.Field "RV_POVariazioneImportoMax", Me.txtVarImpPiu.Value, sTabellaDettaglio
            oDoc.Field "RV_POVariazioneImportoMin", Me.txtVarImpMeno.Value, sTabellaDettaglio
            oDoc.Field "RV_POImportoUnitarioMax", Me.txtImportoMassimo.Value, sTabellaDettaglio
            oDoc.Field "RV_POImportoUnitarioMin", Me.txtImportoMinimo.Value, sTabellaDettaglio
            
            
'            oDoc.Field "RV_POGuidID", GetGUID, sTabellaDettaglio
...
Dim ID As Long
    ...
    If A_Riga(0) > 0 Then
            ...
            oDoc.Field "Art_sco_in_percentuale_2", Me.txtSconto2.Value, sTabellaDettaglio
            oDoc.Field "Art_importo_sconto_netto_IVA", ((Me.txtImponibileUnitario.Value / 100) * (Me.txtSconto1.Value + Me.txtSconto2.Value)), sTabellaDettaglio
            oDoc.Field "Art_importo_totale_lordo_IVA", (Me.txtImponibileUnitario.Value * Me.txtQta_UM) + (((Me.txtImponibileUnitario.Value * Me.txtQta_UM.Value) / 100) * Me.txtAliquotaArticolo.Value), sTabellaDettaglio
            oDoc.Field "Art_importo_totale_netto_IVA", (Me.txtImponibileUnitario.Value * Me.txtQta_UM), sTabellaDettaglio
            oDoc.Field "Art_prezzo_unitario_netto_IVA", Me.txtImportoUnitarioArticolo.Value, sTabellaDettaglio
            oDoc.Field "Art_prezzo_unitario_lordo_IVA", Me.txtImportoUnitarioArticolo.Value + ((Me.txtImportoUnitarioArticolo.Value / 100) * Me.txtAliquotaArticolo.Value), sTabellaDettaglio
            oDoc.Field "Art_pre_uni_net_sco_net_IVA", Me.txtImponibileUnitario.Value, sTabellaDettaglio
            oDoc.Field "Art_pre_uni_net_sco_lor_IVA", Me.txtImponibileUnitario.Value + ((Me.txtImponibileUnitario.Value / 100) * Me.txtAliquotaArticolo.Value), sTabellaDettaglio
            ...
            oDoc.Field "Art_prezzo_unitario_neutro", Me.txtImportoUnitarioArticolo.Value, sTabellaDettaglio
            oDoc.Field "Art_Importo_netto_IVA", Me.txtImponibileArticolo.Value, sTabellaDettaglio
            oDoc.Field "Art_importo_net_sconto_lor_IVA", (Me.txtImponibileUnitario.Value * Me.txtQta_UM) + (((Me.txtImponibileUnitario.Value * Me.txtQta_UM.Value) / 100) * Me.txtAliquotaArticolo.Value), sTabellaDettaglio
            oDoc.Field "Art_importo_net_sconto_net_IVA", (Me.txtImponibileUnitario.Value * Me.txtQta_UM), sTabellaDettaglio
            oDoc.Field "Art_importo_sconto_lordo_IVA", ((Me.txtImponibileUnitario.Value / 100) * (Me.txtSconto1.Value + Me.txtSconto2.Value)), sTabellaDettaglio
...
Select Case oDoc.IDTipoOggetto
    ...
    Case 14
        sSQL = sSQL & fnNormString("Rif. contratto n: /" & GetNumeroDocumentoModificato(Me.lngNumero.Value) & " del " & Me.dtData.Text)
End Select
sSQL = sSQL & "WHERE IDOggetto=" & oDoc.IDOggetto
...
Totale_merce_lavorato = GET_TOTALE_MERCE_DOCUMENTO 'PRELEVA IL TOTALE MERCE NETTO DEGLI IMBALLI
...
'RICALCOLO DELLE PERCENTUALI IN BASE ALL'IMPORTO FISSO
    ...
    rsComm.Open sSQL, Cn.InternalConnection, adOpenDynamic, adLockPessimistic
...
'AGGIUNTA DELLE COMMISSIONI PER CLIENTE
    ...
    Set rs = Cn.OpenResultset(sSQL)
    Set rsComm = New ADODB.Recordset
    rsComm.Open "RV_POCommissioniPerDoc", Cn.InternalConnection, adOpenDynamic, adLockPessimistic
    While Not rs.EOF
...
Me.txtTara.Value = (Me.txtTaraUnitaria.Value * Me.txtColli.Value) + GET_CALCOLA_TARA_CONFEZIONE
...
While Not rs.EOF
    ...
    For I = 0 To rs.Fields.Count - 1
        If rs.Fields(I).Name <> "IDValoriOggettoDettaglio" Then
            If rs.Fields(I).Name <> "RV_POIDValoriOggettoDettaglioContratto" Then
                oDoc.Field rs.Fields(I).Name, rs.Fields(I).Value, sTabellaDettaglio
            Else
                oDoc.Field rs.Fields(I).Name, rs!IDValoriOggettoDettaglio, sTabellaDettaglio
            End If
        End If
    Next
    IRiga = IRiga + 1
...
''Me.txtAndamentoOrdineDett.Top = PBOrdineDettaglio.Top + 35
'
'
...
sSQL_WHERE = "WHERE Oggetto.IDAzienda=" & TheApp.IDFirm
...
sSQL = "SELECT RV_POQuantitaPerCollo, PesoNetto "
...
End Function
Private Sub ParametroGGDataScadenza()
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT NumeroGiorniDataScadContratto, DataScadenzaContrattoObbligatoria "
...
If rs.EOF = False Then
    GG_DATA_SCADENZA = fnNotNullN(rs!NumeroGiorniDataScadContratto)
    DATA_SCADENZA_OBBLIGATORIA = fnNotNullN(rs!DataScadenzaContrattoObbligatoria)
Else
    GG_DATA_SCADENZA = 0
    DATA_SCADENZA_OBBLIGATORIA = 0
End If

rs.CloseResultset
Set rs = Nothing
End Sub
Private Function GET_CONTROLLO_DATE_SOVRAPPOSTE(datainizio As String, datafine As String, tipocontrollo As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

GET_CONTROLLO_DATE_SOVRAPPOSTE = False

sSQL = "SELECT IDOggetto FROM " & sTabellaTestata
sSQL = sSQL & " WHERE Link_Nom_anagrafica=" & Me.cdAnagrafica.KeyFieldID
sSQL = sSQL & " AND RV_POContrattoChiuso = 0"

If tipocontrollo = 1 Then
    sSQL = sSQL & " AND Doc_data<=" & fnNormDate(datafine)
    sSQL = sSQL & " AND Doc_data_scadenza>=" & fnNormDate(datainizio)
End If
If tipocontrollo = 2 Then
    sSQL = sSQL & " AND Doc_data_scadenza IS NULL"
...
If Not rs.EOF Then
    GET_CONTROLLO_DATE_SOVRAPPOSTE = True
End If
...
End Sub
Private Sub SALVA_PAR_QUAL_CONTR(IDOggetto As Long)
On Error GoTo ERR_SALVA_PAR_QUAL
Dim sSQL As String
Dim rs As ADODB.Recordset

If (ELIMINA_PAR_QUAL_CONTR(IDOggetto) = False) Then Exit Sub
...
Exit Sub
ERR_SALVA_PAR_QUAL:
    MsgBox Err.Description, vbCritical, "SALVA_PAR_QUAL_CONTR"
End Sub
Private Function ELIMINA_PAR_QUAL_CONTR(IDOggetto As Long) As Boolean
On Error GoTo ERR_ELIMINA_PAR_QUAL
Dim sSQL As String
Dim rs As ADODB.Recordset

ELIMINA_PAR_QUAL_CONTR = False

sSQL = "DELETE FROM RV_POParametriQualitaContratto "
sSQL = sSQL & " WHERE IDOggetto=" & IDOggetto


Cn.Execute sSQL

ELIMINA_PAR_QUAL_CONTR = True

Exit Function
ERR_ELIMINA_PAR_QUAL:
    MsgBox Err.Description, vbCritical, "ELIMINA_PAR_QUAL_CONTR"
End Function
...
Private Sub txtQual16_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
Private Sub txtVarImpMeno_LostFocus()
    CalcolaTotaleRiga
End Sub

Private Sub txtVarImpPiu_LostFocus()
    CalcolaTotaleRiga
End Sub

Private Sub txtVarPercMeno_LostFocus()
    CalcolaTotaleRiga
End Sub

Private Sub txtVarPercPiu_LostFocus()
    CalcolaTotaleRiga
End Sub
...
ERR_cmdLetteraIntento_Click:
    MsgBox Err.Description, vbCritical, "cmdLetteraIntento_Click"
End Sub
Private Sub EliminaTMPQtaPerSocio()
On Error GoTo ERR_EliminaTMPQtaPerSocio
Dim sSQL As String

sSQL = "DELETE FROM RV_POTMPQuantitaContrattoPerSocio "
sSQL = sSQL & "WHERE IDUtente=" & TheApp.IDUser

Cn.Execute sSQL
Exit Sub
ERR_EliminaTMPQtaPerSocio:
    MsgBox Err.Description, vbCritical, "EliminaTMPQtaPerSocio"
End Sub
Private Sub RECUPERA_QTA_PER_SOCIO_TMP()
On Error GoTo ERR_RecuperaQtaPerSocioPerTMP
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
Dim rsNew As ADODB.Recordset

EliminaTMPQtaPerSocio

sSQL = "SELECT * FROM RV_POTMPQuantitaContrattoPerSocio "
sSQL = sSQL & " WHERE IDUtente=" & TheApp.IDUser
...
sSQL = "SELECT * FROM RV_POIEQuantitaContrattoPerSocio "
sSQL = sSQL & "WHERE IDOggetto=" & oDoc.IDOggetto
...
While Not rs.EOF
    rsNew.AddNew
        ...
        'rsNew!ID_Art_dettaglio_prog = fnNotNullN(rs!ID_Art_dettaglio_prog)
        ...
        rsNew!QuantitaConferita = CALCOLA_TOTALE_CERTIFICATO_PER_SOCIO(fnNotNullN(rs!IDAnagraficaSocio))
    rsNew.Update
rs.MoveNext
Wend
...
Exit Sub
ERR_RecuperaQtaPerSocioPerTMP:
    MsgBox Err.Description, vbCritical, "RecuperaQtaPerSocioPerTMP"
End Sub
Private Sub EliminaQtaPerSocio()
On Error GoTo ERR_EliminaTMPQtaPerSocio
Dim sSQL As String

sSQL = "DELETE FROM RV_POQuantitaContrattoPerSocio "
sSQL = sSQL & "WHERE IDOggetto=" & oDoc.IDOggetto
...
ERR_EliminaTMPQtaPerSocio:
    MsgBox Err.Description, vbCritical, "EliminaTMPQtaPerSocio"
End Sub
Private Sub SALVA_QTA_PER_SOCIO()
On Error GoTo ERR_RecuperaQtaPerSocioPerTMP
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
Dim rsNew As ADODB.Recordset
...
sSQL = "SELECT * FROM RV_POQuantitaContrattoPerSocio "
sSQL = sSQL & " WHERE IDOggetto=" & oDoc.IDOggetto
...
Exit Sub
ERR_RecuperaQtaPerSocioPerTMP:
    MsgBox Err.Description, vbCritical, "SALVA_QTA_PER_SOCIO_TMP"
End Sub
Private Function CALCOLA_TOTALE_CERTIFICATO() As Double
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
Set rs = Nothing
End Function
Private Function CALCOLA_TOTALE_CERTIFICATO_PER_SOCIO(IDSocio) As Double
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
Dim IDValoriOggettoDettaglio As Long

CALCOLA_TOTALE_CERTIFICATO_PER_SOCIO = 0

'sSQL = "SELECT IDValoriOggettoDettaglio "
'sSQL = sSQL & "FROM ValoriOggettoDettaglio0038 "
'sSQL = sSQL & " WHERE IDOggetto=" & oDoc.IDOggetto
''sSQL = sSQL & " AND ID_Art_dettaglio_prog=" & ID
'
'Set rs = Cn.OpenResultset(sSQL)
'
'If Not rs.EOF Then
'  IDValoriOggettoDettaglio = fnNotNullN(rs!IDValoriOggettoDettaglio)
'End If
'
'rs.CloseResultset
'Set rs = Nothing
...
If Not rs.EOF Then
    CALCOLA_TOTALE_CERTIFICATO_PER_SOCIO = fnNotNullN(rs!Totale)
End If
